...
class Car:
    def __init__(self, x, y, space):
       ...
       # Joints for wheels
        ...
        # Damped Springs
        f_spring = pymunk.DampedSpring(chassis_body, f_wheel_body, (50, -35), (0, 0), rest_length=0.01, stiffness=STIFFNESS, damping=DAMPING)
        r_spring = pymunk.DampedSpring(chassis_body, r_wheel_body, (-50, -35), (0, 0), rest_length=0.01, stiffness=STIFFNESS, damping=DAMPING)

        # Motors for wheels
        f_motor = pymunk.SimpleMotor(chassis_body, f_wheel_body, 0)
        r_motor = pymunk.SimpleMotor(chassis_body, r_wheel_body, 0)
